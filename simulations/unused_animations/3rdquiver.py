...
quivers = ax.quiver(x, y, z, u, v, w, length=1.0, colors=cols, normalize=True, linewidth=3)
...
def plot_vectors(x, y, vals, quivers):
    w = 0.450
    l = 0.550
    z_val = 0.1
...
def animate(i):
    val = 0.3
    vals = np.array([[val + 0.02 * i], [val + 0.02 * i], [val], [val]])
    plot_vectors(0.02 * i, 0.02 * i, vals, quivers)
